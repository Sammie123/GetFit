 ...
 */
public class SavedFoodListFragment extends Fragment implements OnStartDragListener {
    ...
    private void setUpFirebaseAdapter() {
        ...
        mFirebaseAdapter = new FirebaseFoodListAdapter(Food.class, R.layout.food_list_item_drag, FirebaseFoodViewHolder.class, query, this, getActivity());
